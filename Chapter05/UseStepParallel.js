...
try {
  step(
    ...
    function writeFiles(err, data1, data2, data3) {
      ...
      // data1 = data1.replace(/burningbird\.net/g, 'somecompany.com')
      // data2 = data2.replace(/burningbird\.net/g, 'somecompany.com')
      // data3 = data3.replace(/burningbird\.net/g, 'somecompany.com')
